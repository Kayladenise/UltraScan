...
from model.metrics import dice_coefficient, intersection_over_union, accuracy as calc_accuracy, ConfusionMatrix
...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, (images, masks) in enumerate(train_loader):
            ...
            acc_total += calc_accuracy(predicted, target)
            num_batches += 1
        ...
        valids, accuracy_value, IoU, mIoU, mat = confusion_matrix.scores()
        print(f'Confusion Matrix:\n{mat}')
        print(f'Accuracy: {accuracy_value:.4f}, mIoU: {mIoU:.4f}')
